...
from ASTA import YouTube, app
from ASTA.core.call import ASTA
from ASTA.misc import SUDOERS, db
from ASTA.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from ASTA.utils.database import get_assistant
from ASTA.utils.decorators.language import languageCB
from ASTA.utils.formatters import seconds_to_min
from ASTA.utils.inline import close_markup, stream_markup, stream_markup_timer
from ASTA.utils.stream.autoclear import auto_clean
from ASTA.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
