...
from ASTA.utils import help_pannel
from ASTA.utils.database import get_lang
from ASTA.utils.decorators.language import LanguageStart, languageCB
from ASTA.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from ASTA.help.buttons import BUTTONS
from ASTA.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_ASTA, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
