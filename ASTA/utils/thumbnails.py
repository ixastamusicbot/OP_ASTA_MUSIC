...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("ASTA/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("ASTA/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("ASTA/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("ASTA/assets/assets/play_icons.png")
